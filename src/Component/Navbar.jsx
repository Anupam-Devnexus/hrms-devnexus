            ...
            <div key={idx}>
              ...
              <div
                className={`ml-10 mt-1 flex flex-col gap-1 overflow-hidden transition-all duration-300 ${
                  openMenus[item.label] ? "max-h-40 opacity-100" : "max-h-0 opacity-0"
                }`}
              >
  ...
  {item.label}
      ...
      <div className="p-4 border-t border-gray-700 flex items-center justify-between">
        ...
        <button
          ...
          className="bg-red-600 hover:bg-red-700 transition-all duration-200 text-white p-2 rounded-full shadow-md"
        >
          <FaPowerOff size={14} />
        </button>
      </div>
